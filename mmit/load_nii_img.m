% internal function of NIFTI toolbox
% Warning: this over-loads Jimmy Shen (jimmy@rotman-baycrest.on.ca),
% especially due to the original lines:
%
% 	% Update the global min and max values 
% 	hdr.dime.glmax = max(double(img(:)));
% 	hdr.dime.glmin = min(double(img(:)));
%
% the double() of which take very long for some large matrices.
%
% Modification made by adalca@mit.edu
