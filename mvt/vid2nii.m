...
% VID2NII write a nifti file from frames
%   VID2NII(videoFile) writes a nifti file from video file videoPath.
%   The file uses VideoReader class to open video files -- see the help
%   file for that class for supported formats. 
%
%   VID2NII(videoFile, outfile) also write the nifti to
